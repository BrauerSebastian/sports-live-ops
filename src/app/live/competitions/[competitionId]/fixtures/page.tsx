    ...
    <div className="public-view">
      ...
      <main className="public-main">
        <div className="public-intro">
          <div><p className="overline">{competition.name} / Fixtures and results</p><h1>Fixtures and results</h1><p className="event-location">{competition.seasons[0]?.name}</p></div>
        </div>
