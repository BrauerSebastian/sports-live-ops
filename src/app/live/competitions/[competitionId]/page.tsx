...
export async function generateMetadata({ params }: { params: Promise<{ competitionId: string }> }): Promise<Metadata> {
  try {
    ...
    return {
      ...
      description: `Fixtures, live events, standings and news for ${competition.name} in the Sports Live Ops demonstration.`,
  ...
  return (
    <div className="public-view">
      <header className="public-header">
        ...
        <Link className="follow-button" href="/live">Live Center</Link>
      </header>
